...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_userprofile', (
            ...
            ('avatar', self.gf('django.db.models.fields.files.ImageField')(default='/static/default-avatar.png', max_length=100)),
    ...
    models = {
        ...
        'profiles.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['profiles.Interest']", 'symmetrical': 'False'}),
