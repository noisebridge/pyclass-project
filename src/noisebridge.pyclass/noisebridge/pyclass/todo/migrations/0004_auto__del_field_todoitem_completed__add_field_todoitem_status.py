...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ToDoItem.completed'
        db.delete_column('todo_todoitem', 'completed')

        # Adding field 'ToDoItem.status'
        db.add_column('todo_todoitem', 'status',
                      self.gf('django.db.models.fields.CharField')(default='O', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ToDoItem.completed'
        db.add_column('todo_todoitem', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ToDoItem.status'
        db.delete_column('todo_todoitem', 'status')
