# Django settings for pyclass project.
import sys
import os
import django

# Get directories to make setting variables easier.
...
MEDIA_ROOT = '' #os.path.join(os.path.dirname(__file__), "media") Not needed in developement
...
STATIC_ROOT = '' # Not needed in dev os.path.join(os.path.dirname(__file__), "static")
